...
# python -m venv Backend/pyenv
# source Backend/pyenv/bin/activate
# pip install --upgrade pip

# minimal deps for runner
pip install whisperx pyannote.audio torch torchaudio transformers soundfile

# lock (optional)
pip freeze > Backend/scripts/requirements.txt

# create runner
cat > Backend/scripts/whisperx_runner.py << 'PY'
