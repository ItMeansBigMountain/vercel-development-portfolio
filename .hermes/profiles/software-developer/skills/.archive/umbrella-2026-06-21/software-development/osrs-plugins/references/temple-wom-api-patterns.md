...
Merged from the older `osrs-plugin-development` skill during umbrella consolidation.
...
- Keep network timeouts short (about 5 seconds) so the plugin does not feel frozen.
