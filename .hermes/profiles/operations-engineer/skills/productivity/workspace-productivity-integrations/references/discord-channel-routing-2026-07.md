...
- `#content-creation`: unified content and social-growth studio covering original and curated content, Parrot AI, AI/regular media creation, editing, publishing, analytics, community management, and multi-platform onboarding. It replaces the narrower `#youtube-automation` lane; existing YouTube/Viral Radar/faceless jobs still deliver there as one part of the broader remit.
