...
❌ Failed
Blockers: auth_expired (all YouTube tokens), source_download_failed (yt-dlp bot checks)
Queue: 1 queued (Chris Williamson clip)
Next action: Run google_reauth_workflow.py for classicalechos/trapiistan/fareed320, then retry with fresh cookies/proxy for source download
Details: See /opt/data/HeRmEz/projects/viral-clip-radar/LOGS/daily_youtube_source_download/ and /opt/data/scripts/youtube_auth_healthcheck.py output
