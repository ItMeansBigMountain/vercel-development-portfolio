...
⚠️ Needs attention
Uploaded: 0 public URLs
Queue: before **1** → after **1**; hold **1**
Pipeline exit: timeout at 420s; raw log was empty
Blocker: `invalid_grant: Token has been expired or revoked.` on all 3 profiles
📌 Fresh OAuth URLs: run `/opt/hermes/.venv/bin/python3 /opt/data/scripts/youtube_auth_healthcheck.py --verbose`; return all full localhost callbacks.
